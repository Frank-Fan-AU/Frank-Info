...
const FrontendTechnologies = [
  { icon: SiReact, name: 'React', description: '', className: 'text-sky-500' },
  { icon: SiNextdotjs, name: 'Next.js', description: '', className: 'text-black' },
  { icon: SiJavascript, name: 'JavaScript', description: '', className: 'text-yellow-400' },
  { icon: SiTypescript, name: 'TypeScript', description: '', className: 'text-blue-600' },
  { icon: SiReact, name: 'React Native', description: '', className: 'text-sky-500' },
  { icon: SiTailwindcss, name: 'Tailwind CSS', description: '', className: 'text-cyan-500' },
  { icon: SiVuedotjs, name: 'Vue', description: '', className: 'text-green-500' },
  { icon: SiJest, name: 'Jest', description: '', className: 'text-red-600' },
  { icon: PlaywrightIcon, name: 'Playwright', description: '', className: 'text-green-600' },
  { icon: SiWebpack, name: 'Webpack', description: '', className: 'text-blue-600' },
  { icon: SiVite, name: 'Vite', description: '', className: 'text-purple-500' }

];

const BackendTechnologies = [
  { icon: SiNodedotjs, name: 'Node.js', description: '', className: 'text-green-600' },
  { icon: SiExpress, name: 'Express', description: '', className: '' },
  { icon: SiAwslambda, name: 'AWS Lambda', description: '', className: 'text-orange-500' },
  { icon: FaJava, name: 'Java', description: '', className: 'text-red-600' },
  { icon: SiSpring, name: 'Spring Boot', description: '', className: 'text-green-600' },
  { icon: SiSharp, name: 'C#', description: '', className: 'text-purple-600' },
  { icon: SiDotnet, name: 'ASP.NET', description: '', className: 'text-purple-600' },
  { icon: SiMysql, name: 'MySQL', description: '', className: 'text-blue-600' },
  { icon: SiMongodb, name: 'MongoDB', description: '', className: 'text-green-600' },
  { icon: SiPostgresql, name: 'PostgreSQL', description: '', className: '' },
  { icon: SiRedis, name: 'Redis', description: '', className: 'text-red-600' },
  { icon: SiAmazons3, name: 'AWS S3', description: '', className: 'text-orange-500' }
]

const OtherTechnologies = [
  { icon: SiGit, name: 'Git', description: '', className: 'text-orange-600' },
  { icon: SiJenkins, name: 'Jenkins', description: '', className: 'text-red-600' },
...
export default function TechStack() {
  ...
  const isInView = useInView(ref, { once: true, margin: "-100px" }); // 只触发一次，提前100px

  return (
    <div className="w-full space-y-12" ref={ref}>
      <div>
